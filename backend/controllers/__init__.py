...
routers = [recurso_controller, reserva_controller, recurso_comum_controller, orcamento_controller, auth_controller, notificacoes_controller, entidade_controller]