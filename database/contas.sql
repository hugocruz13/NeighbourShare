...
/* admin */
IF NOT EXISTS (SELECT 1 FROM [dbo].[Utilizador] WHERE [Email] = 'admin@email.com')
BEGIN
...
/* gestor */
IF NOT EXISTS (SELECT 1 FROM [dbo].[Utilizador] WHERE [Email] = 'gestor@email.com')
BEGIN
    INSERT INTO [dbo].[Utilizador]
               ([NomeUtilizador]
               ,[DataNasc]
...
/* residente */
IF NOT EXISTS (SELECT 1 FROM [dbo].[Utilizador] WHERE [Email] = 'residente@email.com')
BEGIN
    INSERT INTO [dbo].[Utilizador]
               ([NomeUtilizador]
               ,[DataNasc]
